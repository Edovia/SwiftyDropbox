...
public class FilesRoutes {
    ...
    public func alphaUpload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: NSData) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadErrorWithProperties` object on failure.
    public func alphaUpload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: NSURL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
        let route = Files.alphaUpload
        let serverArgs = Files.CommitInfoWithProperties(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute, propertyGroups: propertyGroups)
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadErrorWithProperties` object on failure.
    public func alphaUpload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, propertyGroups: Array<Properties.PropertyGroup>? = nil, input: NSInputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorWithPropertiesSerializer> {
        let route = Files.alphaUpload
        let serverArgs = Files.CommitInfoWithProperties(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute, propertyGroups: propertyGroups)
    ...
    public func download(path: String, rev: String? = nil, overwrite: Bool = false, destination: (NSURL, NSHTTPURLResponse) -> NSURL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.DownloadErrorSerializer> {
    ...
    public func getPreview(path: String, rev: String? = nil, overwrite: Bool = false, destination: (NSURL, NSHTTPURLResponse) -> NSURL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.PreviewErrorSerializer> {
    ...
    public func getThumbnail(path: String, format: Files.ThumbnailFormat = .Jpeg, size: Files.ThumbnailSize = .W64h64, overwrite: Bool = false, destination: (NSURL, NSHTTPURLResponse) -> NSURL) -> DownloadRequestFile<Files.FileMetadataSerializer, Files.ThumbnailErrorSerializer> {
    ...
    public func upload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, input: NSData) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadError` object on failure.
    public func upload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, input: NSURL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let route = Files.upload
        let serverArgs = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
        return client.request(route, serverArgs: serverArgs, input: .File(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadError` object on failure.
    public func upload(path: String, mode: Files.WriteMode = .Add, autorename: Bool = false, clientModified: NSDate? = nil, mute: Bool = false, input: NSInputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let route = Files.upload
        let serverArgs = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
        return client.request(route, serverArgs: serverArgs, input: .Stream(input))
    }
    ...
    public func uploadSessionAppend(sessionId: String, offset: UInt64, input: NSData) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
    ...
    /// `Files.UploadSessionLookupError` object on failure.
    @available(*, unavailable, message: "upload_session/append is deprecated. Use upload_session/append_v2.")
    public func uploadSessionAppend(sessionId: String, offset: UInt64, input: NSURL) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppend
        let serverArgs = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
        return client.request(route, serverArgs: serverArgs, input: .File(input))
    }
    ...
    /// `Files.UploadSessionLookupError` object on failure.
    @available(*, unavailable, message: "upload_session/append is deprecated. Use upload_session/append_v2.")
    public func uploadSessionAppend(sessionId: String, offset: UInt64, input: NSInputStream) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppend
        let serverArgs = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
        return client.request(route, serverArgs: serverArgs, input: .Stream(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, input: NSData) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, input: NSURL) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppendV2
        let serverArgs = Files.UploadSessionAppendArg(cursor: cursor, close: close)
        return client.request(route, serverArgs: serverArgs, input: .File(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Void` object on success or a
    /// `Files.UploadSessionLookupError` object on failure.
    public func uploadSessionAppendV2(cursor: Files.UploadSessionCursor, close: Bool = false, input: NSInputStream) -> UploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let route = Files.uploadSessionAppendV2
        let serverArgs = Files.UploadSessionAppendArg(cursor: cursor, close: close)
        return client.request(route, serverArgs: serverArgs, input: .Stream(input))
    }
    ...
    public func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: NSData) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadSessionFinishError` object on failure.
    public func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: NSURL) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let route = Files.uploadSessionFinish
        let serverArgs = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
        return client.request(route, serverArgs: serverArgs, input: .File(input))
    }
    ...
    ///  - returns: Through the response callback, the caller will receive a `Files.FileMetadata` object on success or a
    /// `Files.UploadSessionFinishError` object on failure.
    public func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, input: NSInputStream) -> UploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let route = Files.uploadSessionFinish
        let serverArgs = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
        return client.request(route, serverArgs: serverArgs, input: .Stream(input))
    }
